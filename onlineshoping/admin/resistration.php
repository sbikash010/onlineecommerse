...
mysqli_query($con,"INSERT INTO admin_users(number,fname,mname,lname,password,email,gender,address1,address2,add_on) Values('$number','$fname','$mname','$lname','$password','$email','$gender','$address1','$address2','$add_on')");
  }
?>
<html>
<head>  
     <title>user registration system using php and mysql</title>
     <link rel="stylesheet" type="text/css" href="resistration.css">
</head>
<body>
<div class="adregist">
